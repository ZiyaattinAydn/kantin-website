(() => {
  ...
  function activate(branch, updateUrl = true) {
    ...
    window.scrollTo({ top: document.querySelector(".branch-selector-wrap").offsetTop - 80, behavior: "smooth" });
  }
  ...
  activate(validBranches.includes(initial) ? initial : "alsancak", false);
})();
